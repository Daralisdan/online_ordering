...
public class JDBC {
    ...
    //sql路径
    private static final String URL = "jdbc:mysql://localhost:3306/online_ordering?serverTimezone=PRC";
    //驱动
...
//            conn.commit();
     ...
     * @return
     */
    public static int update(String sql, Admin admin) {
        //1.连接数据库
        getConn();
