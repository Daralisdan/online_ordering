...
<div style="width:1600px;height: 250px;font-size: 25px; text-align: center;">
    <table id="sys_table" class="easyui-datagrid" title="菜品分类管理" data-options="fitColumns:true">
    </table>
</div>
...
//构建工具栏
        ...
        $('#sys_table').datagrid({
            ...
            toolbar: tbar,
            columns: [[
                {field: 'calalogId', title: 'ID', width: 533, fitColumns: true},
                {field: 'calalogName', title: '菜品分类名', width: 533, fitColumns: true},
                {field: 'calalogDescrible', title: '菜品分类描述', width: 533, fitColumns: true}
            ]]
